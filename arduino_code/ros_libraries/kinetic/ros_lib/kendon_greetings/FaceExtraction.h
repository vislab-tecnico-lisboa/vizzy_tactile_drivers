#ifndef _ROS_kendon_greetings_FaceExtraction_h
#define _ROS_kendon_greetings_FaceExtraction_h
...
namespace kendon_greetings
{

  class FaceExtraction : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "kendon_greetings/FaceExtraction"; };
