#ifndef _ROS_pedestrian_detector_BoundingBox_h
#define _ROS_pedestrian_detector_BoundingBox_h
...
namespace pedestrian_detector
{
  ...
  class BoundingBox : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Point _person3dLocation_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_tracked.base >> (8 * 0)) & 0xFF;
      ...
      offset += this->person3dLocation.serialize(outbuffer + offset);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->tracked);
      offset += this->person3dLocation.deserialize(inbuffer + offset);
     return offset;
    }

    const char * getType(){ return "pedestrian_detector/BoundingBox"; };
    const char * getMD5(){ return "10e5b2361740386e88e5a80aa25a88f8"; };
