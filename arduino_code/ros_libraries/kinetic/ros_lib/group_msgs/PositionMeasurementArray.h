#ifndef _ROS_group_msgs_PositionMeasurementArray_h
#define _ROS_group_msgs_PositionMeasurementArray_h
...
#include "group_msgs/PositionMeasurement.h"
...
namespace group_msgs
{
  ...
  class PositionMeasurementArray : public ros::Msg
  {
    public:
      ...
      typedef group_msgs::PositionMeasurement _people_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(people_lengthT > people_length)
        this->people = (group_msgs::PositionMeasurement*)realloc(this->people, people_lengthT * sizeof(group_msgs::PositionMeasurement));
      people_length = people_lengthT;
      for( uint32_t i = 0; i < people_length; i++){
      offset += this->st_people.deserialize(inbuffer + offset);
        memcpy( &(this->people[i]), &(this->st_people), sizeof(group_msgs::PositionMeasurement));
      }
    ...
    const char * getType(){ return "group_msgs/PositionMeasurementArray"; };
