#ifndef _ROS_group_msgs_People_h
#define _ROS_group_msgs_People_h
...
namespace group_msgs
{
  ...
  class People : public ros::Msg
  {
    public:
      ...
      typedef group_msgs::Person _people_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(people_lengthT > people_length)
        this->people = (group_msgs::Person*)realloc(this->people, people_lengthT * sizeof(group_msgs::Person));
      people_length = people_lengthT;
      for( uint32_t i = 0; i < people_length; i++){
      offset += this->st_people.deserialize(inbuffer + offset);
        memcpy( &(this->people[i]), &(this->st_people), sizeof(group_msgs::Person));
      }
     return offset;
    }

    const char * getType(){ return "group_msgs/People"; };
    const char * getMD5(){ return "41e7b90a14688036f1b4eb709c1abf92"; };
