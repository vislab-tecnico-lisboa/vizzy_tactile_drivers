#ifndef _ROS_human_awareness_msgs_BoundingBox_h
#define _ROS_human_awareness_msgs_BoundingBox_h
...
namespace human_awareness_msgs
{
  ...
  class BoundingBox : public ros::Msg
  {
    ...
    const char * getType(){ return "human_awareness_msgs/BoundingBox"; };
